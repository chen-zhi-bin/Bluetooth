package com.program.bluetooth.util;
...
public class BtReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (dev != null) {
            Log.d(TAG,"BluetoothDevice "+dev.getName()+" , "+dev.getAddress());
        }
        switch (action){
            ...
            case BluetoothDevice.ACTION_BOND_STATE_CHANGED:
                Log.d(TAG,"BOND_STATE: "+intent.getIntExtra(BluetoothDevice.EXTRA_BOND_STATE,0));
                break;
            ...
            case BluetoothAdapter.ACTION_CONNECTION_STATE_CHANGED:
                Log.d(TAG,"CONN_STATE: "+intent.getIntExtra(BluetoothAdapter.EXTRA_CONNECTION_STATE,0));
                break;
            case BluetoothHeadset.ACTION_CONNECTION_STATE_CHANGED:
                Log.d(TAG,"CONN_STATE: " + intent.getIntExtra(BluetoothHeadset.EXTRA_STATE,0));
                break;
            case BluetoothA2dp.ACTION_CONNECTION_STATE_CHANGED:
                Log.d(TAG,"CONN_STATE: "+intent.getIntExtra(BluetoothA2dp.EXTRA_STATE,0));
                break;
        }
    }
